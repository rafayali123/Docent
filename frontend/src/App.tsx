...
function App() {
  ...
  // Active Document Metadata State (Updated for Supabase UUID tracking)
  ...
  const handleUpload = async () => {
    ...
    try {
      ...
      // Set active document metadata mapping the true Supabase document_id
      setDocumentInfo({
  ...
  const handleAsk = async () => {
    ...
    try {
      ...
      // Pass the strict Supabase document_id to scoped RAG query
      const data = await askQuestion(userQuestion, documentInfo.documentId);
            ...
            <div className="card-header">
              ...
              <div className="icon-box">
                <svg
                  ...
                  strokeLinejoin="round"
                >
                  <path d="M12 3c.132 0 .263 0 .393 0a7.5 7.5 0 0 0 7.92 7.92c0 .13 0 .261 0 .391 0 .132 0 .263 0 .393a7.5 7.5 0 0 0-7.92 7.92c-.13 0-.261 0-.391 0-.132 0-.263 0-.393 0a7.5 7.5 0 0 0-7.92-7.92c0-.13 0-.261 0-.391 0-.132 0-.263 0-.393 0a7.5 7.5 0 0 0 7.92-7.92c.13 0 .261 0 .391 0z" />
                </svg>
              </div>
            </div>
